...
TriggerEvent('chat:addSuggestion', '/unban', 'Insert the complete name of the player to unban', {
    { name="complete player name", help="Insert player name of the player to unban" },
})
...
TriggerEvent('chat:addSuggestion', '/tempban', 'You can tempban player with the name, id or part of the name', {
    { name="player to ban", help="Insert player name, id or part of the name" },

...
local faim = 100                                   -- Init hunger's variable. Set to 100 for development. 
local soif = 100                                  -- Init thirst's variable. Set to 100 for development. 
